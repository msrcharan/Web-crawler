# -*- coding: utf-8 -*-
"""Crawler-Individual_BBCNews.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Ptzth_H27fTmPhJKSOkiExF2yqswGd-Q
"""
    ...
    for i in range(1,2000):
      try:
        ...
        if target_url not in self.scraped_pages:
          print("Scraping URL: {}".format(target_url)) #--------Main_URL
          li.append(target_url)
...
if __name__ == '__main__':
  cc = MultiThreadedCrawler("https://www.bbc.com/news")
  cc.run_web_crawler(li)
  cc.info()
...
for i in range(len(li)):
  name = '/content/drive/MyDrive/crawler_data/'+"doc"+str(i)+".txt"
  contents = downloader(li[i])
